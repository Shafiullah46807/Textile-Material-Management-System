...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<br><br><a href="index.php?page=sales" class="nav-item nav-sales"><span class='icon-field'><i class="fa fa-clipboard-list "></i></span> Sales</a>
				...
				<a href="index.php?page=suppliers" class="nav-item nav-suppliers"><span class='icon-field'><i class="fa fa-list-alt "></i></span> Customer</a>
